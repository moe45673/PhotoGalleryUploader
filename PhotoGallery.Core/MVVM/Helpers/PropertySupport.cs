    ...
    public static class PropertySupport
    {
        ...
        internal static string ExtractPropertyNameFromLambda(LambdaExpression expression)
        {
            ...
            if (memberExpression == null)
                throw new ArgumentException(resourceMap.GetValue("PropertySupport_NotMemberAccessExpression_Exception", resourceContext).ValueAsString, nameof(expression));

            var property = memberExpression.Member as PropertyInfo;
            if (property == null)
                throw new ArgumentException(resourceMap.GetValue("PropertySupport_StaticExpression_Exception", resourceContext).ValueAsString, nameof(expression));
